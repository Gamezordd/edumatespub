...
export const ExtraCurricular: DropdownItemProps[]=[
	...
	{value:'Choirs — community or religious',text:'Choirs — community or religious'},
	{value:'Marching bands',text:'Marching bands'},
	{value:'Singing lessons',text:'Singing lessons'},
	{value:'Sound engineering or mixing classes for older children',text:'Sound engineering or mixing classes for older children'},
	{value:'Drawing and painting classes',text:'Drawing and painting classes'},
	{value:'Animation',text:'Animation'},
	...
	{value:'Poetry clubs, classes or workshops',text:'Poetry clubs, classes or workshops'},
	{value:'Storytelling sessions',text:'Storytelling sessions'},
	{value:'Creative writing classes or clubs',text:'Creative writing classes or clubs'},
	{value:'Working on a school magazine or journal',text:'Working on a school magazine or journal'},
	...
	{value:'Clubs for the sciences (Physics, Biology, Chemistry, Astronomy, etc.)',text:'Clubs for the sciences (Physics, Biology, Chemistry, Astronomy, etc.)'},
	...
	{value:'Web design/coding clubs or classes',text:'Web design/coding clubs or classes'},
	{value:'Choreography or dance clubs/classes',text:'Choreography or dance clubs/classes'},
	{value:'Sports such as football, basketball, volleyball, cricket, swimming etc.',text:'Sports such as football, basketball, volleyball, cricket, swimming etc.'},
	...
	{value:'Community service (volunteering in orphanages or old age homes, running charity drives, etc.)',text:'Community service (volunteering in orphanages or old age homes, running charity drives, etc.)'},
