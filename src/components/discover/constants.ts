...
export const universities = [
	{
		...
		image: 'https://manipal.edu/content/dam/manipal/mu/images/galleryImage/Simulation%20Centre/SimCentre1.JPG.transform/manipal-edu-transform-width-height-752px/image.jpg',
		details: {
