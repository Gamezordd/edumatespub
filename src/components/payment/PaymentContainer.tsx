          ...
          {plans.map((plan) => (
            ...
            <Card fluid>  
              <Card.Content className="paycard">
                <Grid > 
                  <Grid.Row>
                    <Grid.Column width={16} > <div className="blackbg">
                      <Grid.Row className="hidden">  .. </Grid.Row>
                      <Grid.Row className="hidden">  .. </Grid.Row>
                   
                      < Grid.Row><p className="planname"> {plan.name} </p>  </Grid.Row>
                      <Grid.Row className="hidden">  .. </Grid.Row>
                      < Grid.Row><p className="price"> $ {plan.price} </p> </Grid.Row>
                      <Grid.Row className="hidden">  .. </Grid.Row>
                      < Grid.Row >   <div className="wrapper">  <p className="button"><button onClick={(e) => this.startPayment(plan)}>{plan.button}</button> </p> </div>  </Grid.Row>
                      <Grid.Row className="hidden">  .. </Grid.Row>                    </div>
                      <Grid.Row className="hidden">  .. </Grid.Row>
